...
class BodyRenderer:
    ...
    def draw_body(screen, body, pan_x, pan_y, zoom, display_scale, velocity_scale=20):
        ...
        if (
            -50 <= scaled_x < screen.get_width() + 50
            and -50 <= scaled_y < screen.get_height() + 50
        ):
    ...
    def draw_velocity_vector(
        screen, body, pan_x, pan_y, zoom, display_scale, velocity_scale=20
    ):
        ...
        pygame.draw.line(
            screen, (255, 255, 255), (scaled_end_x, scaled_end_y), (left_x, left_y), 2
        )
        pygame.draw.line(
            screen, (255, 255, 255), (scaled_end_x, scaled_end_y), (right_x, right_y), 2
        )
